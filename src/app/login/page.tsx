...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen w-full bg-navy-gradient-deep font-body">
      ...
      <div className="relative hidden lg:flex lg:w-[50%] flex-col justify-center p-12 text-white overflow-hidden">
      ...
      {/* Right Side - Form */}
      <div className="flex w-full flex-col items-center justify-center bg-transparent p-4 py-12 lg:w-[50%] lg:p-12">
        {/* Mobile Logo */}
